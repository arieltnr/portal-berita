...
/* @var $articles array */
/* @var $bookmarkedUrls array */
/* @var $ratings array */
/* @var $category string */

$this->title = $category ? ucfirst($category) . ' Berita - Portal' : 'Top Headlines - Portal';
...
<div class="news-container">
    <h2 class="mb-4">
        <?php if ($category): ?>
            <i class="fas fa-tag"></i> <?= ucfirst($category) ?> News Today
        <?php else: ?>
            <i class="fas fa-fire"></i> Top Headlines (US)
        <?php endif; ?>
    </h2>
                ...
                <div class="article-content">
                    ...
                    <?php if (!empty($article['content'])): ?>
                        <p class="text-muted small">
                            <i class="fas fa-align-left"></i> <?= Html::encode(substr($article['content'], 0, 150)) ?>...
                        </p>
                    <?php endif; ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="rating-section">
                            ...
                            <button class="rating-btn rating-up <?= $thumbsUpActive ?>"
                                data-type="up"
                                <?= Yii::$app->user->isGuest ? 'disabled title="Please login to rate"' : '' ?>>
